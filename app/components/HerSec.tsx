...
const HerSec = () => {
  return (
    <div className='flex flex-col items-center align-middle text-center justify-center mx-auto py-6 relative'>
        <Image src={BlueStar} width={200} height={200} alt='BlueStar' className='-bottom-100 -left-190 relative'/>
        <Image src={OrangeStarBg} width={180} height={180} alt='OrangeStar' className='top-3 -right-20 absolute'/>

        <div className='flex items-center flex-col lg:font-6xl text-8xl text-black max-w-4xl mx-auto'>
        ...
        <div className='flex flex-row  gap-4  items-center  mx-auto mt-4'>
